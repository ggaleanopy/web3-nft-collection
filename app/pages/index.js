    ...
    export default function Home() {
      ...
      const publicMint = async () => {
        try {
          ...
          // call the mint from the contract to mint the WorldCupBalls
          ...
          await tx.wait();
          setLoading(false);
          window.alert("You successfully minted a WorldCupBalls!");
        } catch (err) {
          console.error(err);
        }
      };
      ...
      */
      const renderButton = () => {
        ...
        return (
          <button className={styles.button_circle} onClick={publicMint}>
            Public Mint
          </button>
        );
      };
        ...
        <div>
          ...
          <div className={styles.main}>
            <div>
              ...
              <div className={styles.description}>
                {tokenIdsMinted}/22 have been minted
              </div>
              {renderButton()}
            </div>
            <div>
